...
const getAll = () => {
	...
	return request.then((response) => response.data.concat(nonExisting)); // nonExisting es una nota inventada que no se guardó en el servidor, para probar que funciona la promesa
};
