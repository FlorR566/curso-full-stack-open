# 📚 Full Stack Open — Parte 2

### _Renderizado dinámico, formularios y comunicación con el servidor_

Este repositorio contiene los ejercicios correspondientes a la **Parte 2** del curso **Full Stack Open** dictado por la Universidad de Helsinki.  
...
Cada carpeta contiene ejercicios específicos de cada sección.
